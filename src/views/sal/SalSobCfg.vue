<template>
  <div>
    ...
    <el-table :data="emps" border size="mini" stripe>
      ...
      <el-table-column label="操作" align="center">
        <template slot-scope="scope">
          <el-popover title="编辑工资账套" placement="left"
                      @show="showPop(scope.row.salary)" @hide="hidePop(scope.row)" width="200" trigger="click">
            <div>
