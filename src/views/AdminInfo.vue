    ...
    <el-card class="box-card">
      ...
      <div>
        <div style="display: flex; justify-content: center">
          <el-upload action="/admin/userface" :headers="header" :data="admin" :on-success="onSuccess"
                     :show-file-list="false">
            <img title="点击修改用户头像" :src="admin.userFace" style="width: 100px; height: 100px; border-radius: 50px"
                 alt="头像加载失败"/>
          </el-upload>
        </div>
