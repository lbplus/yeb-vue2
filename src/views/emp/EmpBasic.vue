  ...
  <div>
    ...
    <div>
      <div style="display: flex; justify-content: space-between">
        ...
        <div>
          ...
          <el-button style="margin-left: 10px" icon="el-icon-search" type="primary" @click="initEmps">搜索</el-button>
        ...
        <div>
          ...
          <el-button type="primary" icon="el-buttton-plus" @click="showAddEmpView">添加员工</el-button>
        </div>
      ...
      <div v-show="showSearch"
        ...
        <el-row style="margin-top: 10px">
          ...
          <el-col :span="5" :offset="4">
            ...
            <el-button size="mini" @click="closeDemo">取消</el-button>
          </el-col>
        </el-row>
    ...
    <div style="margin-top: 20px">
      <el-table
        ...
        <el-table-column prop="name" label="姓名" fixed="left" align="left" width="90"></el-table-column>
        ...
        <el-table-column prop="nativePlace" label="籍贯" width="88"></el-table-column>
        ...
        <el-table-column prop="joblevel.name" label="职称" align="left" width="100"></el-table-column>
            ...
            <el-col :span="5">
              <el-form-item label="聘用形式" prop="engageForm">
                <el-radio-group v-model="emp.engageForm">
                  <el-radio label="劳动合同" style="margin-top: 10px">劳动合同</el-radio>
                  <el-radio label="劳务合同" style="margin-top: 10px">劳务合同</el-radio>
                </el-radio-group>
              </el-form-item>
            </el-col>
            ...
            <el-col :span="12">
              <el-form-item label="婚姻状况" prop="wedlock">
                <el-radio-group v-model="emp.wedlock">
                  <el-radio label="已婚" style="margin-top: 10px">已婚</el-radio>
                  <el-radio label="未婚" style="margin-top: 10px">未婚</el-radio>
                  <el-radio label="离异" style="margin-top: 10px">离异</el-radio>
                </el-radio-group>
              </el-form-item>
            </el-col>
          </el-row>
    ...
    initEmps(type) {
      ...
      if (type && type == "advanced") {
        ...
        if (this.searchValue.beginDateScope) {
          url += "&startDate=" + this.searchValue.beginDateScope[0] + "&endDate=" + this.searchValue.beginDateScope[1];
        }
        if (this.empName) {
