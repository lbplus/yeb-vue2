<template>
  <div>
    ...
    <div>
      <el-input v-model="jl.name" size="small" placeholder="添加职位"
      ...
      <el-button size="small" type="danger" :disabled="multipleSelection.length === 0" @click="deleteMany">
        批量删除
      </el-button>
    </div>

    <div>
      <el-table :data="jls" size="small" stripe border style="width: 100%; margin-top: 10px"
                @selection-change="handleSelectionChange">

        <el-table-column type="selection" width="55"></el-table-column>
        <el-table-column prop="id" label="编号" width="180"></el-table-column>
        <el-table-column prop="name" label="职称名" width="180"></el-table-column>
        ...
        <el-table-column label="操作" width="150">
          <template slot-scope="scope">
            ...
            <el-button size="small" type="danger" @click="deleteJobLevel(scope.$index, scope.row)">删除</el-button>
          </template>
        </el-table-column>
    ...
    <el-dialog title="编辑职称" :visible.sync="dialogVisible" width="30%">
      ...
      <table>
        <tr>
          ...
          <td>
            <el-input v-model="updateJl.name" size="small" style="width: 190px"></el-input>
          </td>
        </tr>
        <tr>
          <td>
...
export default {
  ...
  methods: {
    ...
    deleteMany() {
      this.$confirm("删除[" + this.multipleSelection.length + "]个职位, 是否继续?", "提示",
